...
public class LuaForAPostfixTemplate extends StringBasedPostfixTemplate {
    public LuaForAPostfixTemplate(@NotNull PostfixTemplateProvider provider) {
        super("for", "for", "for i = 1, expr do end", selectorTopmost(Conditions.alwaysTrue()), provider);
    }
