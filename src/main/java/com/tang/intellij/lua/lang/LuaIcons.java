...
public class LuaIcons {
    public static final Icon FILE = IconLoader.getIcon("/icons/lua.png", LuaIcons.class);
    public static final Icon CSHARP = IconLoader.getIcon("/icons/csharp.png", LuaIcons.class);
    public static final Icon CPP = IconLoader.getIcon("/icons/cpp.png", LuaIcons.class);
    ...
    public static final Icon ANNOTATION = IconLoader.getIcon("/icons/annotation.png", LuaIcons.class);
    public static final Icon META_METHOD = IconLoader.getIcon("/icons/meta.png", LuaIcons.class);
    ...
    public static final Icon MODULE = IconLoader.getIcon("/icons/module.png", LuaIcons.class);

    public static final Icon STRING_ARG_HISTORY = AllIcons.Vcs.History;

    public static final Icon LAYER = IconLoader.getIcon("/icons/lua_layer.svg", LuaIcons.class);
    public static final Icon ROOT = IconLoader.getIcon("/icons/lua_root.svg", LuaIcons.class);
    public static final Icon PROJECT = IconLoader.getIcon("/icons/lua_project.svg", LuaIcons.class);

    public static final Icon SMART_SUGGESTION = AllIcons.Nodes.Aspect;

    public static class LineMarker {
        public static final Icon TailCall = IconLoader.getIcon("/icons/tail.png", LuaIcons.class);
    }

    public static class Debugger {
        public static final Icon Console = IconLoader.getIcon("/icons/console.svg", LuaIcons.class);
        public static final Icon StackFrame = IconLoader.getIcon("/icons/frame.svg", LuaIcons.class);
